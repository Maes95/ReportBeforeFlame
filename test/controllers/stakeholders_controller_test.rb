...
class StakeholdersControllerTest < ActionController::TestCase
  ...
  test "should create stakeholder" do
    assert_difference('Stakeholder.count') do
      post :create, stakeholder: { email: @stakeholder.email, lastname: @stakeholder.lastname, name: @stakeholder.name }
    end
  ...
  test "should update stakeholder" do
    patch :update, id: @stakeholder, stakeholder: { email: @stakeholder.email, lastname: @stakeholder.lastname, name: @stakeholder.name }
    assert_redirected_to stakeholder_path(assigns(:stakeholder))
  end
